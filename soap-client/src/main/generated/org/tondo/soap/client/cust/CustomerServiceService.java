 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceService", targetNamespace = "http://svc.server.soap.tondo.org/", wsdlLocation = "http://localhost:8080/soap-server/cust?wsdl")
public class CustomerServiceService
    extends Service
{

    private final static URL CUSTOMERSERVICESERVICE_WSDL_LOCATION;
    private final static WebServiceException CUSTOMERSERVICESERVICE_EXCEPTION;
    private final static QName CUSTOMERSERVICESERVICE_QNAME = new QName("http://svc.server.soap.tondo.org/", "CustomerServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/soap-server/cust?wsdl");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://svc.server.soap.tondo.org/", "CustomerServicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://svc.server.soap.tondo.org/", "CustomerServicePort"), CustomerService.class, features);
    }
